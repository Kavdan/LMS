...
class TakenCourse(models.Model):
    ...
    def calculate_cgpa(self):
        ...
        if str(current_semester) == SECOND:
            ...
            print("балы по курсу = ", taken_course_points)
            print("часы по курсу = ", taken_course_credits)
            print("средний балл первого семестра = ", first_sem_gpa)
            print("средний балл второго семестра = ", sec_sem_gpa)
            print("итоговый балл = ", round(taken_course_points / taken_course_credits, 2))
